...
def main() -> None:
    ...
    # Keep this after the normal handlers and in a later group so it only
    # handles callback data that none of the registered handlers matched.
    app.add_handler(CallbackQueryHandler(unhandled_callback), group=1)
